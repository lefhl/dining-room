...
phone_block.addEventListener('mouseenter', () => {
    const popup = document.querySelector('.popup');
    const popup_inner = document.querySelector('.popup__container');
    
    popup.classList.add('active');

    popup_inner.style.marginLeft = phone_block.getBoundingClientRect().left + phone_block.getBoundingClientRect().width - popup_inner.getBoundingClientRect().width + 'px';
